...
@Component({
  selector: 'app-weather-nuwara-eliya',
  templateUrl: './weather-nuwara-eliya.component.html',
  styleUrls: ['./weather-nuwara-eliya.component.scss']
})
export class WeatherNuwaraEliyaComponent implements OnInit {
