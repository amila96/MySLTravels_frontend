...
@Component({
  selector: 'app-weather-galle-fort',
  templateUrl: './weather-galle-fort.component.html',
  styleUrls: ['./weather-galle-fort.component.scss']
})
export class WeatherGalleFortComponent implements OnInit {
